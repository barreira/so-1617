...
/*
 * @brief Este programa reproduz todas as linhas acrescentando-lhe uma nova
 * coluna com o resultado de uma operacão (avg, max, min, sum) é calculada sobre
 * os valores da coluna indicada nas linhas anteriores.
 * 
 *        e.g. window <coluna> <operacao> <linhas>
 *
 * Utilização: ./a.out 1 sum 3
 *
 * input: 10:a:b
 * output: 10:a:b:10
 *
...
int main(int argc, char const *argv[]) {
	int cut, n, i, res, first = 0, s, linhas, colunas;
